...
# -run on port 8001, useful when other sites are using other ports
...
# Function to run a local web server on port 8001 using the Python version that is found
...
runWebServer () {
        echo "View the web application in a browser with http://localhost:8001"
